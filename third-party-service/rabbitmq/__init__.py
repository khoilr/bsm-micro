...
rabbitmq_is_face_presented_heartbeat_timeout = int(
    os.environ.get("RABBITMQ_IS_FACE_PRESENTED_HEARTBEAT_TIMEOUT", 600)
)

is_face_presented_queue = os.environ.get("IS_FACE_PRESENTED_QUEUE", "is_face_presented")
face_identification_exchange = os.environ.get(
    "FACE_IDENTIFICATION_EXCHANGE", "face_identification"
)
face_identification_exchange_type = os.environ.get(
    "FACE_IDENTIFICATION_EXCHANGE_TYPE", "fanout"
)
face_identification_queue = os.environ.get(
    "FACE_IDENTIFICATION_QUEUE", "face_identification"
)
face_identification_heartbeat = int(
    os.environ.get("FACE_IDENTIFICATION_HEARTBEAT", 600)
)
face_identification_rpc_queue = os.environ.get(
...
class RabbitMQ:
    def __init__(self) -> None:
        ...
        self.channel.queue_bind(
            exchange=face_identification_exchange, queue=face_identification_exchange
        )
        ...
        # self.channel.queue_bind(
        #     exchange=is_face_presented_exchange, queue=is_face_presented_queue
        # )
